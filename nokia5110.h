...
// Check if the pixel on x and y is 1 if so return true; 
uint8_t nokia_lcd_check_pixel(uint8_t x, uint8_t y);
uint8_t nokia_lcd_check_hella_pixel(uint8_t x ,uint8_t y,uint8_t cur_type,uint8_t _type);
